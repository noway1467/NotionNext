...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://icy-kitten-abf.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '文章内容网络收集，如有侵权请留言删除', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yyzs.cloudns.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ACGN,博客,二次元,资源分享,动画,漫画,GalGame', // 网站关键词 英文逗号隔开
